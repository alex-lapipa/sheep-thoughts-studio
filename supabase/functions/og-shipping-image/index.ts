...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const title = lang === 'en' ? 'Shipping & Returns' : 'Envíos y Devoluciones';
    const subtitle = lang === 'en' 
      ? 'Packages travel through trained moles' 
      : 'Los paquetes viajan por topos entrenados';
...
Ultra high resolution, clean modern design.`;
    ...
    const fallbackSvg = `
      <svg width="1200" height="630" xmlns="http://www.w3.org/2000/svg">
        ...
        <text x="600" y="350" text-anchor="middle" font-family="Georgia, serif" font-size="48" font-weight="bold" fill="#2C2C2C">Shipping & Returns</text>
        <text x="600" y="420" text-anchor="middle" font-family="Georgia, serif" font-size="28" fill="#666">Bubbles the Sheep</text>
        <text x="600" y="480" text-anchor="middle" font-family="Georgia, serif" font-size="22" fill="#888">Packages travel through trained moles</text>
      </svg>
    `;
