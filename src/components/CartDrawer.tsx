          ...
          {items.length === 0 ? (
            <div className="flex-1 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-muted-foreground font-display">Bubbles thinks you should add something...</p>
              </div>
            </div>
          ) : (
            <>
                  ...
                  {items.map((item) => (
                    <div key={item.variantId} className="flex gap-4 p-3 rounded-lg bg-secondary/30">
                      ...
                      <div className="flex-1 min-w-0">
                        <h4 className="font-display font-semibold truncate">{item.product.node.title}</h4>
              ...
              <div className="flex-shrink-0 space-y-4 pt-4 border-t bg-background">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-xl font-display font-bold">{items[0]?.price.currencyCode || 'EUR'} {totalPrice.toFixed(2)}</span>
                </div>
                <Button 
