...
import { 
  ...
  CheckCircle, AlertCircle, RefreshCw, BarChart3, Search, Wrench, Flower2, Car
} from 'lucide-react';
...
const mentors = [
  ...
  },
  {
    ...
    description: "Hippie uncle with guitar, rusty Beetle full of holes, his girlfriend Mairead, and their wise dog Muffins (named after Mairead's shop).",
    bubblesInterpretation: "Aidan spoke about spirituality, music, and 'the universe, like...' before trailing off. His girlfriend Mairead worked at a shop called Muffins, so they named the dog Muffins. (Her real name is ZZ Top Lady.) Muffins would stare at the hills, understanding everything Aidan couldn't finish. Unfinished sentences contain more truth than complete ones.",
    signaturePhrase: "The universe is, you know...",
    topics: ["Music", "Spirituality", "Cosmic mysteries", "Muffins the dog", "Mairead"],
    sampleQuestion: "What's the connection between music and the soul? Tell me something cosmic.",
    triggers: ["music", "soul", "cosmic", "universe", "spiritual", "guitar", "Muffins", "hippie", "Mairead", "ZZ Top"],
  ...
  },
  {
    ...
    triggers: ["fix", "broken", "repair", "tools", "DIY", "build", "mechanical", "whack"],
    color: "text-cyan-500",
  ...
  },
  {
    ...
    triggers: ["gentle", "kind", "garden", "flowers", "nature", "soft", "peaceful", "calm"],
    color: "text-pink-500",
  ...
  },
  {
    ...
    triggers: ["drive", "road", "journey", "lost", "adventure", "stuck", "direction", "route"],
