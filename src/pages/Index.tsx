...
export default function Index() {
  ...
  return (
    <Layout>
      ...
      {/* Inside My Head - Interactive Thought Gallery (hidden when simplifiedHomepage enabled) */}
      {!simplifiedHomepage && <InsideMyHeadHero />}

      {/* About Section (hidden when simplifiedHomepage enabled) */}
      {!simplifiedHomepage && (
      ...
      {/* Credentials (hidden when simplifiedHomepage enabled) */}
      {!simplifiedHomepage && (
