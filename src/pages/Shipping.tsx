...
import { Package, Truck, Clock, MapPin, RotateCcw, AlertTriangle, Globe, Thermometer, Bird, Ship, List } from "lucide-react";
...
const Shipping = () => {
  ...
  const tocItems: TocItem[] = [
    { id: "how-shipping-works", title: language === 'en' ? "How Shipping Works" : "Cómo Funciona", level: 1 },
    { id: "delivery-times", title: language === 'en' ? "Delivery Times" : "Tiempos de Entrega", level: 1 },
    { id: "factors-affecting-delivery", title: language === 'en' ? "Factors Affecting Delivery" : "Factores", level: 1 },
    { id: "returns-policy", title: language === 'en' ? "Returns Policy" : "Devoluciones", level: 1 },
    { id: "non-returnable", title: language === 'en' ? "Non-Returnable Items" : "No Devolvibles", level: 1 },
    { id: "damaged-items", title: language === 'en' ? "Damaged Items" : "Artículos Dañados", level: 1 },
    { id: "contact", title: language === 'en' ? "Questions" : "Preguntas", level: 1 },
  ];
      ...
      <div className="container py-12">
        <div className="flex gap-8">
              ...
              <Card className="absolute bottom-16 right-0 w-64 bg-card/95 backdrop-blur-sm shadow-xl animate-fade-in">
                <CardHeader className="pb-2">
                  <CardTitle className="text-sm font-medium">
                    {language === 'en' ? 'Jump to Section' : 'Ir a Sección'}
                  </CardTitle>
                </CardHeader>
          ...
          <div className="flex-1 max-w-3xl">
            ...
            {/* Shipping Factors */}
            <section id="factors-affecting-delivery">
              <Card className="mb-6">
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
